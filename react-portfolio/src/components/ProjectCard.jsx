    ...
    <div className={`project-card ${reverse ? 'reverse' : ''}`}>
      <div className="project-image" style={{ background: gradient }}>
        <div className="project-image-content">
          ...
          <div className="project-visual">
            {visual.map((visualType, index) => (
              <div key={index} className={`visual-element ${visualType}`}></div>
            ))}
          </div>
        </div>
      </div>
      <div className="project-content">
        ...
        <a href={githubUrl} target="_blank" rel="noopener noreferrer" className="github-btn">
          <svg className="github-icon" xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="currentColor">
